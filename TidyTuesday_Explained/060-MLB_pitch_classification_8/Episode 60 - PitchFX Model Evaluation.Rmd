...
model_nn <- function( train, test, ..., model_seed = 555, data_prep_function = list(data_scale)){
  ...
  ## return
  class_prob <- predict(fit_nb, newdata = test_x, type = "raw")
  class_pred <- data.frame() %>% 
...
nn_standard_up <- model_nn(train_cleaned, test_cleaned, data_prep_function = list(data_upsample), seed = 123456)
nn_standard_down <- model_nn(train_cleaned, test_cleaned, data_prep_function = list(data_downsample), seed = 123456)
